...
export default function AddMemberApp() {
    const { uid } = useParams();
    ...
    const partnerOptions = myTreeData.filter(person =>
        person.relation && person.relation.includes('Partner')
    );

    // Check if there are at least two parents in the data
    const parentCount = myTreeData.filter(person =>
        person.relation && person.relation === 'Parent'
    ).length;
        ...
        <>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        >
                            <option value="">Select a relation</option>
                            {[
                                { label: "Parent", value: "Parent", disabled: parentCount >= 2 },
            ...
            <div>
                ...
                <Modal show={showParentModal} onHide={handleCancelModal}>
                    ...
                    <Modal.Body>
                        <p>At least two parents are required to select "Sibling" as a relation. Please add parents first.</p>
                    </Modal.Body>
                    <Modal.Footer>
                        <Button variant="secondary" onClick={handleCancelModal}>
                            OK
