...
//         localStorage.setItem("account_privacy", name)
...
//       cloudinaryData.append("upload_preset", "profile")
...
//           <input type="file" accept="image/*" onChange={handleImageChange} className="d-none" id="profileImageInput" />
...
//             {userData?.fullName}
//             {userData?.greenTick ? <Image className="ms-1 verified" src={Verified || "/placeholder.svg"} /> : ""}
//             {userData?.isLinked ? <Image className="ms-1 link" src={LinkIcon || "/placeholder.svg"} /> : ""}
//           </div>
...
//             <Image className="ms-1 link" src={PpCoin || "/placeholder.svg"} />
//           </div>
//         </div>
//         <div></div>
//       </div>
...
//           <span className="number fw-bold">{list.length}</span> Post
//         </span>
//         <span className="count">
//           <span className="number fw-bold">{followers.length}</span> Followers
//         </span>
//       </div>
...
//           <Nav.Item>
//             <Nav.Link className="px-4" eventKey="setting">
//               Settings
//             </Nav.Link>
//           </Nav.Item>
//           <Nav.Item>
//             <Nav.Link className="px-4" eventKey="info">
//               Info
//             </Nav.Link>
//           </Nav.Item>
//           <Nav.Item>
//             <Nav.Link className="px-4" eventKey="post">
//               Posts
//             </Nav.Link>
//           </Nav.Item>
//           <Nav.Item>
//             <Nav.Link className="px-4" eventKey="photos">
//               Photos
//             </Nav.Link>
//           </Nav.Item>
//           <Nav.Item>
//             <Nav.Link className="px-4" eventKey="videos">
//               Videos
//             </Nav.Link>
//           </Nav.Item>
//           <Nav.Link className="px-4" onClick={() => setShowFollowersModal(true)}>
//             Followers
//           </Nav.Link>
//         </Nav>
...
//                 <Link
//                   onClick={setting.handleClick ? setting.handleClick : () => false}
//                   key={index}
//                   to={setting.to}
//                   className="d-flex justify-content-between align-items-center rounded_border bg_secondary text-decoration-none py-6 px-3 mb-3"
//                 >
//                   <span className="same_poppins_4 fw-500 fs-6">{setting.name}</span>
//                   <Button variant="dark" className=" bg_primary rounded-pill small-arrow-btn">
//                     <Image className="rotate-180 img-fluid" src={LeftArroow || "/placeholder.svg"} />
//                   </Button>
//                 </Link>
//               ))}
...
//             <button onClick={logout} type="submit" className="add_member_btn login-btn btn-block mb-4 px-5 mx-auto">
//               Logout
//             </button>
...
//           <Tab.Pane eventKey="info">{info && <InfoTab info={info} />}</Tab.Pane>
...
//                       />
//                     )}
//                     <Image src={imgUrl || "/placeholder.svg"} alt={`Photo ${index + 1}`} />
//                   </Link>
//                 </div>
//               ))}
//             </div>
...
//                     />
//                   ) : (
//                     <div style={{ position: "relative", cursor: "pointer" }} onClick={() => setPlayingVideo(index)}>
//                       <video
//                         src={mediaUrl}
//                         className="w-100"
//                         muted
...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (savedSetting) {
      setSelectedPrivacy(savedSetting)
    } else if (userData?.account_privacy) {
      // If no saved setting but user data has privacy setting, use that
      setSelectedPrivacy(userData.account_privacy)
    }
  }, [userData])
