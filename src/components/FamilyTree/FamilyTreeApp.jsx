...
const FamilyTreeApp = () => {
    ...
    useEffect(() => {
        const fetchFamilyData = async () => {
            console.log("useruseruser", id);

            try {
                const data = await familyTree(id);
    ...
    const defineTemplates = () => {
        ...
        FamilyTree.templates.base.defs =
            `<g transform="matrix(0.05,0,0,0.05,-12,-9)" id="line">
        ...
        FamilyTree.templates.main.nodeMenuButton =
       ...
       <rect x="60" y="26" width="80" height="80"></rect>
        ...
        FamilyTree.templates.main_male.node = '<rect x="0" y="0" height="{h}" width="{h}" fill="#ffffff" stroke-width="3" stroke="#6bb4df" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#6bb4df" rx="5" ry="5"></rect>';
        FamilyTree.templates.main_other = Object.assign({}, FamilyTree.templates.main);
       ...
       <rect x="60" y="26" width="80" height="80"></rect>
        ...
        FamilyTree.templates.main_female.node = '<rect x="0" y="0" height="{h}" width="{h}" fill="#ffffff" stroke-width="3" stroke="#6bb4df" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#6bb4df" rx="5" ry="5"></rect>';
        ...
        FamilyTree.templates.single_male.node = '<rect x="0" y="0" height="{h}" width="{h}" fill="#ffffff" stroke-width="3" stroke="#6bb4df" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#6bb4df" rx="5" ry="5"></rect>';
        ...
        FamilyTree.templates.single_female.node = '<rect x="0" y="0" height="{h}" width="{h}" fill="#ffffff" stroke-width="3" stroke="#6bb4df" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#6bb4df" rx="5" ry="5"></rect>';
        ...
        FamilyTree.templates.single_step.node = '<rect x="0" y="0" height="{h}" width="{h}" fill="#ffffff" stroke-width="3" stroke="#6bb4df" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#6bb4df" rx="5" ry="5"></rect>';
        ...
        FamilyTree.templates.male.node = '<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="3" stroke="#ccc" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#b1b9be" rx="5" ry="5"></rect>';

        FamilyTree.templates.male.field_0 = '<text ' + FamilyTree.attr.width + ' ="160" style="font-size: 14px;" font-variant="all-small-caps"  font-weight="bold" fill="black" x="100" y="115" text-anchor="middle">{val}</text>';
        FamilyTree.templates.male.field_1 = '<text ' + FamilyTree.attr.width + ' ="190" data-text-overflow="multiline" style="font-size: 16px;" fill="black" x="100" y="135" text-anchor="middle">{val}</text>';
        FamilyTree.templates.male.field_2 =
            '<text ' + FamilyTree.attr.width + ' ="60" style="font-size: 12px;" fill="black" x="100" y="180" text-anchor="middle">{val}</text>';
        FamilyTree.templates.male.field_3 =
            '<text ' + FamilyTree.attr.width + ' ="100" style="font-size: 12px;" fill="black" x="100" y="180" text-anchor="middle">{val}</text>';
    ...
    `;
        ...
        FamilyTree.templates.female.node = '<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="3" stroke="#ccc" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#b1b9be" rx="5" ry="5"></rect>';

        FamilyTree.templates.female.field_0 = '<text ' + FamilyTree.attr.width + ' ="160" style="font-size: 14px;" font-variant="all-small-caps"  font-weight="bold" fill="black" x="100" y="115" text-anchor="middle">{val}</text>';
        FamilyTree.templates.female.field_1 = '<text ' + FamilyTree.attr.width + ' ="190" data-text-overflow="multiline" style="font-size: 16px;" fill="black" x="100" y="135" text-anchor="middle">{val}</text>';
        ...
        /// Non binary code.....
        FamilyTree.templates.non_binary = Object.assign({}, FamilyTree.templates.tommy);
        FamilyTree.templates.non_binary.size = [200, 200];
        FamilyTree.templates.non_binary.node = '<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="3" stroke="#ccc" rx="5" ry="5"></rect>' +
            '<rect x="0" y="0" height="0" width="{w}" fill="#6bb4df" stroke-width="1" stroke="#b1b9be" rx="5" ry="5"></rect>';

        FamilyTree.templates.non_binary.field_0 = '<text ' + FamilyTree.attr.width + ' ="160" style="font-size: 14px;" font-variant="all-small-caps"  font-weight="bold" fill="black" x="100" y="115" text-anchor="middle">{val}</text>';
        FamilyTree.templates.non_binary.field_1 = '<text ' + FamilyTree.attr.width + ' ="190" data-text-overflow="multiline" style="font-size: 16px;" fill="black" x="100" y="135" text-anchor="middle">{val}</text>';
    ...
    const initFamilyTree = () => {
        ...
        try {
            ...
            family.on('click', function (sender, args) {
                ...
                // const newUrl = `https://example.com/${clickedId}`;
                const newUrl = `/add-mamber-app/${uid}`;
